"""
Django settings for old_boat_dev_93864 project.
...
ROOT_URLCONF = 'old_boat_dev_93864.urls'
...
WSGI_APPLICATION = 'old_boat_dev_93864.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "old_boat_dev_93864 API",
    "DESCRIPTION": "API documentation for old_boat_dev_93864 App",
    "VERSION": "v1",
}
